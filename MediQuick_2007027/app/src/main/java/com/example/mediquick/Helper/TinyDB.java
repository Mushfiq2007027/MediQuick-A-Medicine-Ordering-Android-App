...
public class TinyDB {
    ...
    public ArrayList<Medicines> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Medicines> playerList =  new ArrayList<Medicines>();

        for(String jObjString : objStrings){
            Medicines player  = gson.fromJson(jObjString,  Medicines.class);
    ...
    public void putListObject(String key, ArrayList<Medicines> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Medicines player: playerList){
